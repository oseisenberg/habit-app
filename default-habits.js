...
function getDefaultHabits() {
    ...
    return [
        ...
        { id: 38, name: 'Floss', icon: '🧵', timeOfDay: null, frequency: { type: 'daily' }, completions: [], skippedDates: [], snoozedUntil: null, snoozeHistory: [], subtasks: [], createdAt: today, momentumScore: 0, lastScoreUpdate: today, usePoints: false, allowOptional: false, isReminder: false, isLarge: false, linkedHabit: 36 },
        ...
        ], createdAt: today, momentumScore: 0, lastScoreUpdate: today, usePoints: false, allowOptional: false, isReminder: true, isLarge: false, description: '', isNegative: false, confirmDescription: false, autoCompletes: '', linkedHabit: 47 },
